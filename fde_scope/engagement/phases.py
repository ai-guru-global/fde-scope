...
PHASES: list[Phase] = [
    ...
    Phase(8, "validate", "干系人验证", Zone.BUILD, description="与真实干系人（含冲突成功指标的）验证。"),
    Phase(
        9,
        "deploy",
        "部署上线",
    ...
    Phase(
        12, "runbook", "Runbook 编写", Zone.OPERATIONALIZATION, description="事件响应、回滚、安全失败模式。"
    ),
    Phase(
        13,
        "monitoring_drift",
    ...
    # --- Zone D: Handoff / Exit -----------------------------------------------
    Phase(
        16, "ops_handoff", "运维移交", Zone.HANDOFF, description="所有权转交 Customer Success / 客户运维。"
    ),
    Phase(
        17,
        "knowledge_transfer",
